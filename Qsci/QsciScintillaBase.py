...
class QsciScintillaBase(__PyQt4_QtGui.QAbstractScrollArea):
    ...
    def fromMimeData(self, QMimeData): # real signature unknown; restored from __doc__
        """ QsciScintillaBase.fromMimeData(QMimeData) -> (QByteArray, bool) """
        pass
    ...
    def inputMethodQuery(self, Qt_InputMethodQuery): # real signature unknown; restored from __doc__
        """ QsciScintillaBase.inputMethodQuery(Qt.InputMethodQuery) -> QVariant """
        pass
    ...
    def SCN_FOCUSIN(self, *args, **kwargs): # real signature unknown
        """ QsciScintillaBase.SCN_FOCUSIN [signal] """
        pass

    def SCN_FOCUSOUT(self, *args, **kwargs): # real signature unknown
        """ QsciScintillaBase.SCN_FOCUSOUT [signal] """
        pass
    ...
    def SCN_HOTSPOTDOUBLECLICK(self, *args, **kwargs): # real signature unknown
        """ QsciScintillaBase.SCN_HOTSPOTDOUBLECLICK[int, int] [signal] """
        pass

    def SCN_HOTSPOTRELEASECLICK(self, *args, **kwargs): # real signature unknown
        """ QsciScintillaBase.SCN_HOTSPOTRELEASECLICK[int, int] [signal] """
        pass
    ...
    def SCN_UPDATEUI(self, *args, **kwargs): # real signature unknown
        """ QsciScintillaBase.SCN_UPDATEUI[int] [signal] """
        pass
    ...
    def SendScintilla(self, p_int, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
    ...
    def SendScintillaPtrResult(self, p_int): # real signature unknown; restored from __doc__
    ...
    def toMimeData(self, QByteArray, bool): # real signature unknown; restored from __doc__
        """ QsciScintillaBase.toMimeData(QByteArray, bool) -> QMimeData """
        pass
