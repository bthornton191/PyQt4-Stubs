...
class QPixmap(QPaintDevice):
    ...
    def fromWinHBITMAP(self, sip_voidptr, QPixmap_HBitmapFormat_format=None): # real signature unknown; restored from __doc__
        """ QPixmap.fromWinHBITMAP(sip.voidptr, QPixmap.HBitmapFormat format=QPixmap.NoAlpha) -> QPixmap """
        return QPixmap

    def fromWinHICON(self, sip_voidptr): # real signature unknown; restored from __doc__
        """ QPixmap.fromWinHICON(sip.voidptr) -> QPixmap """
        return QPixmap
    ...
    def grabWindow(self, sip_voidptr, int_x=0, int_y=0, int_width=-1, int_height=-1): # real signature unknown; restored from __doc__
        """ QPixmap.grabWindow(sip.voidptr, int x=0, int y=0, int width=-1, int height=-1) -> QPixmap """
        return QPixmap
    ...
    def toWinHBITMAP(self, QPixmap_HBitmapFormat_format=None): # real signature unknown; restored from __doc__
        """ QPixmap.toWinHBITMAP(QPixmap.HBitmapFormat format=QPixmap.NoAlpha) -> sip.voidptr """
        pass

    def toWinHICON(self): # real signature unknown; restored from __doc__
        """ QPixmap.toWinHICON() -> sip.voidptr """
        pass
