# encoding: utf-8
# module PyQt4.Qt
# from C:\Python27\lib\site-packages\PyQt4\Qt.pyd
# by generator 1.145
# no doc
...
from PyQt4.QAxContainer import QAxBase, QAxObject, QAxWidget

from PyQt4.QtCore import (MSG, POINT, QAbstractAnimation, 
    QAbstractEventDispatcher, QAbstractFileEngine, QAbstractFileEngineHandler, 
...
from PyQt4.QtGui import (QAbstractButton, QAbstractGraphicsShapeItem, 
    ...
    QQuaternion, QLinearGradient, QRadioButton, QRawFont, QRegExpValidator, 
    ...
    QWindowStateChangeEvent, QWizard, QWizardPage, QWorkspace, qAlpha, qApp, 
    qBlue, qDrawBorderPixmap, qDrawPlainRect, qDrawShadeLine, qDrawShadePanel, 
...
from PyQt4.QtMultimedia import (QAbstractVideoBuffer, QAbstractVideoSurface, 
    QAudio, QAudioDeviceInfo, QAudioFormat, QAudioInput, QAudioOutput, 
...
from PyQt4.QtOpenGL import (QGL, QGLBuffer, QGLColormap, QGLContext, 
    QGLFormat, QGLFramebufferObject, QGLFramebufferObjectFormat, 
...
PYQT_CONFIGURATION = {
    'sip_flags': '-x VendorID -t WS_WIN -t Qt_4_8_6 -x Py_v3',
}
